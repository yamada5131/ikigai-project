      ...
      <div className="flex items-center justify-center bg-gray-300">
        <form className="flex flex-col w-7/12 bg-white gap-y-20 my-20 rounded-md shadow-lg">
          ...
          <div className="flex flex-col items-center gap-y-10">
            ...
            <button className="place-self-end w-1/6 -translate-x-44 border-blue-600 border-2 rounded-full text-xl">
              添付
            </button>
            <button className="place-self-end w-1/6 -translate-x-44 bg-blue-700 text-white text-xl rounded-md p-2 mb-20">
              完了
            </button>
          </div>
        </form>
